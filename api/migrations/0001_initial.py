# Generated by Django 3.1.6 on 2021-03-18 19:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_key', models.UUIDField(default=uuid.uuid1, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_At', models.DateTimeField(auto_now_add=True)),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.studentsdata')),
            ],
        ),
        migrations.CreateModel(
            name='AttendenceData',
            fields=[
                ...
                ('school_left', models.TimeField(null=True)),
                ('status', models.CharField(choices=[('inschool', 'Currently In School'), ('left', 'Left The School')], max_length=20)),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.studentsdata')),
            ],
        ),
    ]
